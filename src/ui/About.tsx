    ...
    <div className="scrim" onMouseDown={(e) => e.target === e.currentTarget && close()} style={{ paddingTop: '9vh' }}>
      <div className="dialog" role="dialog" aria-modal="true" aria-label="About GALAXY" style={{ overflowY: 'auto', maxHeight: '84vh' }}>
        ...
        <div className="grid2" style={{ padding: '18px 28px', gap: 22 }}>
          ...
          <div className="wide"><div className="label">Imagery</div><p className="value" style={{ margin: '6px 0 0', color: 'var(--dim)' }}>Earth's day, night and cloud imagery is from Solar System Scope (solarsystemscope.com), CC BY 4.0, derived from NASA Blue Marble, Black Marble and MODIS data. Every other planet surface, and Earth's own fallback while that imagery loads, is procedural GLSL, not a photograph. Deep-space illustrations are canvas paintings.</p></div>
          <div className="wide"><div className="label">Limitations</div>
            <p className="value" style={{ margin: '6px 0 0', color: 'var(--dim)' }}>The Solar System view is not to scale. The Milky Way uses a simplified four-arm model. Deep-space objects sit in their true sky directions on a logarithmic distance scale.</p></div>
        </div>
